...
export default {
  ...
  methods: {
    async login(username, password) {
      const res = await axios.post(`http://${process.env.VUE_APP_API_URL}/api/login`, {
        username,
        password
    ...
    async register(email, username, password, role) {
      const res = await axios.post(`http://${process.env.VUE_APP_API_URL}/api/user`, {
        email,
        username,
        password,
        role
    ...
    async modifyWork(id, url, title) {
      return await axios.put(`http://${process.env.VUE_APP_API_URL}/api/work/${id}`, {
        url,
        name: title
      }, {withCredentials: true});
    },
    ...
    async getKeywords(id){
      return await axios.get(`http://${process.env.VUE_APP_API_URL}/api/keyword?userId=${id}`, {withCredentials: true})
    },
    async getAllKeywords() {
      return await axios.get(`http://${process.env.VUE_APP_API_URL}/api/keyword`, {withCredentials: true})
    },
