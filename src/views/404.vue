<template>
    <main style="text-align: center;">
        <CHeading as="h1">Page not found</CHeading>
        ...
        <CLink as="router-link" to="/" bg="black" color="white" borderRadius="sm" p="3" display="block" width="fit-content" mx="auto">Go back to home</CLink>
    </main>
</template>

<script>
import {CHeading, CLink} from "@chakra-ui/vue";
export default {
    components: {CHeading, CLink}
}
</script>
