...
<script>
import {CBox, CImage, CHeading, CButton, CRadio, CRadioGroup, CInput, CSelect, CTextarea,CBreadcrumb,CBreadcrumbItem,CBreadcrumbLink} from "@chakra-ui/vue";

export default {
  components: {CBox, CImage, CHeading, CButton, CRadio, CRadioGroup, CInput, CSelect, CTextarea,CBreadcrumb,CBreadcrumbItem,CBreadcrumbLink},
  data() {
    return {
      offers: [],
      userP: null,
